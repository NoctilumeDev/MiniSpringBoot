...
/** M4 落地演示：从 application.yml / application-prod.yml 真实读值，切换 profile 验证覆盖。 */
public class ConfigDemo {

    public static void main(String[] args) {
        System.out.println("=== M4 外部化配置落地演示 ===");
        run("prod");
        System.out.println();
    ...
    private static void run(String profile) {
        ...
        AppProperties app = ctx.getBean("appProperties", AppProperties.class);
